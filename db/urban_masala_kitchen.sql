CREATE DATABASE  IF NOT EXISTS `urban_masala_kitchen` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `urban_masala_kitchen`;
-- MySQL dump 10.13  Distrib 8.0.31, for Win64 (x86_64)
--
-- Host: localhost    Database: urban_masala_kitchen
-- ------------------------------------------------------
...
INSERT INTO `food_items` VALUES (1,'Pav Bhaji',70.00),(2,'Chole Bhature',150.00),(3,'Pizza',150.00),(4,'Mango Lassi',40.00),(5,'Masala Dosa',120.00),(6,'Vegetable Biryani',120.00),(7,'Vada Pav',40.00),(8,'Rava Dosa',140.00),(9,'Samosa',15.00);
